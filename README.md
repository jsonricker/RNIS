...
Welcome to the Rochester Neighborhood Intelligence Suite. This repository contains a powerful collection of Python programs designed to gather, filter, and output critical localized data for Rochester, NY. 
...
1. AIO (AIO.py)
The All-In-One Master Intelligence Dashboard.
* Functionality: An interactive Command Line Interface (CLI) that combines all five data streams into a single menu. It includes memory for your API key and a "Run All Reports" feature for a complete city-wide analysis.

2. ZillowRecentlySold (ZillowRecentlySold.py)
...
4. NewBusinesses (NewBusinesses.py)
...
5. ActiveConstruction (ActiveConstruction.py)
...
6. FestivalFinder (FestivalFinder.py)
...
To run the complete interactive master dashboard, execute:
python AIO.py
